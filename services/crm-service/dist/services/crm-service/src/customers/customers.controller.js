...
const common_2 = require("../../../../packages/common/src");
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'ایجاد یک مشتری جدید' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'دریافت لیست تمام مشتریان مستأجر فعلی' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'دریافت اطلاعات یک مشتری خاص' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'به‌روزرسانی اطلاعات یک مشتری' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'حذف یک مشتری' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'مشتری با موفقیت حذف شد.' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
